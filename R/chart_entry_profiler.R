...
#' Entry Profiler Chart Generator
#'
#' @description
#' Generate entry profiler chart for a given backtest report.
#' @param aggregates A backtest report generated by the backtest function.
#' @param entry_timestamps Entry timestamps to analyze.
#' @param lookback Number of bars to look back for each position. Default is 15.
#' @param lookahead Number of bars to look ahead for each position. Default is 50.
#' @param ylim Optional y-axis limits for the plot.
#' @export

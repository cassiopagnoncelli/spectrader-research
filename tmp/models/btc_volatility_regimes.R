...
print("Aligned data structure:")
print(head(aligned))
print(paste("Columns:", paste(colnames(aligned), collapse = ", ")))

# Create exogenous variables dataset
exo <- withexovars(aligned, indexed = TRUE)
print("Exogenous variables dataset:")
print(head(exo))

# Convert to xts for modeling
exoxts <- as.xts(exo)
print("Final xts structure:")
print(head(exoxts))
print(paste("Target variable (btc.main):", colnames(exoxts)[1]))
